...
def solve_wave_equation_leapfrog_linearproblem(Lx, Nx, dt, T, c, output_filepath="wave_solution_leapfrog_linearproblem.bp"):
    """
...
if __name__ == "__main__":
    ...
    solve_wave_equation_leapfrog_linearproblem(Lx, Nx, dt, T, c, output_filepath="wave_solution_leapfrog_linearproblem.bp")
